            ...
            <%
                    ...
                    if (action != null && action.equals("insert")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                            "INSERT INTO period_probation (reason, student_id,quarter_id ) VALUES (?, ?, ?)");
                ...
                <table border="1">
                    ...
                    <tr>
                        <form action="probationInfo.jsp" method="get">
                            ...
                            <th><input value="e.g. get sick" name="reason" size="20"></th>
                            <th><input value="e.g.5322" name="student_id" size="10"></th>
                            <th><input value="e.g.20180927" name="quarter_id" size="15"></th>
