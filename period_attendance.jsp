            ...
            <%
                    ...
                    if (action != null && action.equals("insert")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                            "INSERT INTO period_attendance(student_id,quarter_id) VALUES (?, ?)");

                        pstmt.setInt(1, Integer.parseInt(request.getParameter("student_id")));
                        pstmt.setInt(2, Integer.parseInt(request.getParameter("quarter_id")));
...
<%--            %>--%>
            ...
            <!-- Add an HTML table header row to format the results -->
                <table border="1">
                    ...
                    <tr>
                        <form action="period_attendance.jsp" method="get">
                            <input type="hidden" value="insert" name="action">
                            <th><input value="" name="student_id" size="10"></th>
                            <th><input value="" name="quarter_id" size="15"></th>
