            ...
            <%
                    ...
                    if (action != null && action.equals("insert")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                            "INSERT INTO Department_course(course_name,department_id) VALUES (?, ?)");
...
<%--            %>--%>
            ...
            <!-- Add an HTML table header row to format the results -->
                <table border="1">
                    ...
                    <tr>
                        <form action="department_course.jsp" method="get">
                            <input type="hidden" value="insert" name="action">
                            <th><input value="e.g." name="course_id" size="20"></th>
                            <th><input value="e.g." name="department_id" size="20"></th>
