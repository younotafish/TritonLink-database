            ...
            <%
                    ...
                    if (action != null && action.equals("insert")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                            "INSERT INTO Undergrade_to_graduate VALUES (?, ?, ?)");

                        pstmt.setInt(1, Integer.parseInt(request.getParameter("program_id")));
                        pstmt.setInt(2, Integer.parseInt(request.getParameter("undergraduate_id")));
                        pstmt.setInt(3, Integer.parseInt(request.getParameter("graduate_id")));
...
<%--            %>--%>
            ...
            <!-- Add an HTML table header row to format the results -->
                <table border="1">
                    ...
                    <tr>
                        <form action="undergrade_to_graduate.jsp" method="get">
                            <input type="hidden" value="insert" name="action">
                            <th><input value="" name="program_id" size="10"></th>
                            <th><input value="" name="undergraduate_id" size="10"></th>
                            <th><input value="" name="graduate_id" size="15"></th>
