        ...
        <tr>
            ...
            <%
                    ...
                    if (action != null && action.equals("insert")) {
                        ...
                        pstmt.setInt(1, Integer.parseInt(request.getParameter("graduate_id")));
                        ...
                        pstmt.setInt(4, Integer.parseInt(request.getParameter("thesis_committee_id")));
                ...
                <table border="1">
                    ...
                    <tr>
                        <form action="graduate.jsp" method="get">
                            ...
                            <th><input value="" name="graduate_id" size="10"></th>
                            <th><input value="" name="student_id" size="10"></th>
                            <th><input value="" name="department_id" size="15"></th>
                            <th><input value="" name="thesis_committee_id" size="15"></th>
