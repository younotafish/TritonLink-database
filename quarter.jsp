            ...
            <%
                    ...
                    if (action != null && action.equals("insert")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                                "INSERT INTO Quarter (quarter_id,quarter_year,quarter_type) VALUES (?,?,?)");
                        pstmt.setInt(1,Integer.parseInt(request.getParameter("quarter_id")));
                        pstmt.setInt(2, Integer.parseInt(request.getParameter("quarter_year")));
                        pstmt.setString(3, request.getParameter("quarter_type"));
...
<%--            %>--%>
            ...
            <!-- Add an HTML table header row to format the results -->
                <table border="1">
                    ...
                    <tr>
                        <form action="quarter.jsp" method="get">
                            <input type="hidden" value="insert" name="action">
                            <th><input value="e.g.202001" name="quarter_id" size="15"></th>
                            <th><input value="e.g.2020" name="quarter_year" size="10"></th>
                            <th><input value="e.g.SPRING" name="quarter_type" size="10"></th>
