            ...
            <%
                    ...
                    if (action != null && action.equals("insert")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                                "INSERT INTO Quarter_courses (quarter_id,course_name,section_id) VALUES (?,?,?)");
...
<%--            %>--%>
            ...
            <!-- Add an HTML table header row to format the results -->
                <table border="1">
                    ...
                    <tr>
                        <form action="quarterToCourse.jsp" method="get">
                            <input type="hidden" value="insert" name="action">
                            <th><input value="e.g.201801" name="quarter_id" size="15"></th>
                            <th><input value="e.g.CSE132B" name="course_name" size="10"></th>
                            <th><input value="e.g.201801CSE132BA01" name="section_id" size="20"></th>
